...
// If POST request method is made to update mobileNo and email...
...
<form action="" method="post">
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" name="Contact" id="inputContact" value="<?php echo $_SESSION['Contact']?>">
    </div>
  </div>
  <!-- Update button -->
