            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mt-5 mb-3 clearfix">
                        <h2 class="pull-left">Annual Rent Status</h2>
                        <a href="sk_payRent.php" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Pay Rent</a>
                    </div>
                    <hr>
                    <?php
                    ...
                    $SkID = $_SESSION['SkID'];
                    $sql = "SELECT * FROM annual_rent WHERE SID = (SELECT SID FROM association WHERE SkID = $SkID)";
                    if($result = mysqli_query($conn, $sql)){

                        // Insert a table to show rent status for a particular shop
