...
if(isset($_POST["SID"]) && !empty(trim($_POST["SID"]))){
    ...
    // Prepare mysqli query to update shop details
    ...
    // If it executes successfully, redirect to home page
    // where user can view the UPDATED shop details
...
<form action="" method="post">
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" name="Contact" id="inputContact" value="<?php echo $Contact?>" title="Mobile no should be of 10 digits" pattern="[1-9]{1}[0-9]{9}">
    </div>
  </div>
  <div class="form-row">
    <!-- create a dropdown for Shop Location -->
    <div class="form-group col-md-6">
