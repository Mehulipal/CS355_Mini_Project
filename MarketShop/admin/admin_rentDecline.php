...
if(isset($_POST["SID"]) && !empty($_POST["SID"])){
    ...
    // Delete the add shopkeeper request once declined
    $sql = "DELETE FROM request_rent WHERE SID = ? AND PayForWhichMonth = ? AND PayForWhichYear = ?";
    ...
    if($stmt = mysqli_prepare($conn, $sql)){
        ...
        if(mysqli_stmt_execute($stmt)){
            // Records deleted successfully. Redirect...
            header("location: admin_rentReq.php");
            exit();
        } else{
...
<body>
    <div class="wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="mt-5 mb-3">Decline Rent Request</h2>
