...
if ($_SERVER['REQUEST_METHOD'] == "POST")
{
  ...
  {
    // Prepare mysqli query to check if SID already exists in database 
  ...
  if(empty($SID_err))
  {
    ...
    if ($stmt)
    {
      ...
      // If it executes successfully, redirect to admin_home page
      if (mysqli_stmt_execute($stmt))
      {
    ...
    <div class="form-group col-md-6">
      ...
      <label for="inputDept">Location</label>
        <select name="Location" id="inputLocation">
          <option value="Tutorial Block">Tutorial Block</option>
          <option value="Old Boy's Hostel">Old Boy's Hostel</option>
