...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <a class="navbar-brand" href="admin_home">Admin</a>
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="#">Room_Status(AV/NAV)</a>
      </li>
      <li class="nav-item">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mt-5 mb-3 clearfix">
                        <h2 class="pull-left">Room Status (AV/NV)</h2>
                    </div>
                    <hr>
                    <?php
                            ...
                            echo '<table class="table table-bordered table-striped">';
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        if($row['RoomTypeID']==1){
                                          echo "<td>With Attached Bathroom</td>";
                                        }else{
                                          echo "<td>With Non-Attached Bathroom</td>";
                                        } 
                                        echo "<td>" . $row['Availability'] . "</td>";
                                        echo "<td>";
                                            echo '<a href="admin_shopDelete.php?RoomNo='. $row['RoomNo'] .'" title="Delete Room" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
                                        echo "</td>";
                                        echo "</td>";
                                    echo "</tr>";
                                }
