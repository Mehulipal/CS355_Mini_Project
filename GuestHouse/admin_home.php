            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mt-5 mb-3 clearfix">
                        <h2 class="pull-left">Room Booking Details</h2>
                    </div>
                    <hr>
                    <?php
                            ...
                            echo '<table class="table table-bordered table-striped">';
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                            echo '<a href="admin_shopRead.php?GuestID='. $row['GuestID'] .'" class="mr-3" title="View Guest" data-toggle="tooltip"><span class="fa fa-eye"></span></a>';
