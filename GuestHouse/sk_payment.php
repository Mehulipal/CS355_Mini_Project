...
<html lang="en">
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="#">Payment Receipt</a>
      </li>
      <li class="nav-item">
...
<hr>
                    ...
                    $sql = "SELECT * FROM guestinfo,reserve,payments WHERE guestinfo.GuestID = reserve.GuestID AND reserve.GuestID = payments.GuestID AND guestinfo.EmpID = '$EmplID' ";
                            ...
                            echo '<table class="table table-bordered table-striped">';
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>" . $row['FoodBill'] . "</td>";
                                        echo "<td>" . $row['RoomRent']+$row['FoodBill'] . "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            
                            echo "</table>";
