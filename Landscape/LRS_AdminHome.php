  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    <ul class="navbar-nav">
      <li class="nav-item active">
        <a class="nav-link" href="#">Work Roster Details<span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link" href="EquipmentAdd.php">Equipment Details</a>
      </li>
      <li class="nav-item">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    $sql = "SELECT * FROM WorkRosterAndRecord";
                            ...
                            echo '<table class="table table-bordered table-striped">';
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>" . $row['Job'] . "</td>";
                                        echo "<td>" . $row['HoursAlloted'] . "</td>";
                                        echo "<td>";
                                           // echo '<a href="admin_shopRead.php?SID='. $row['SID'] .'" class="mr-3" title="View Shop" data-toggle="tooltip"><span class="fa fa-eye"></span></a>';
                                            echo '<a href="LRS_WorkRosterUpdate.php?KeyDate='. $row['KeyDate'] .'&GID='. $row['GID'] .'&LID='. $row['LID'] .'&Shift='. $row['Shift'] .'&HoursAlloted='. $row['HoursAlloted'].'&HoursDone='. $row['HoursDone'] .'" class="mr-3" title="Update Shop" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>';
                                            //echo '<a href="LRS_WorkRosterUpdate.php" class="mr-3" title="Update Shop" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>';
